      ...
      <div class="accessory-result-page accessory-page">
        <div class="container">
          <div class="filter-nav">
            ...
            <a href="javascript:void(0)" class="price" @click="sortGoods()">Price <svg class="icon-arrow-short" v-bind:class="{'sort-up':!sortFlag}"><use xlink:href="#icon-arrow-short"></use></svg></a>
    ...
    export default{
      ...
      methods:{
        ...
        sortGoods(){   // 点击排序商品
          ...
          this.getGoodsList(false);  // 重新加载数据
        },
        loadMore(){   // 滚动加载插件方法
